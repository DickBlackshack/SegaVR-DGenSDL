...
RCVAR(dgen_segavr_left_b, 0);
RCVAR(dgen_segavr_right_r, 0);
...
RCVAR(dgen_segavr_hmd_pitch_scale, 4);
RCVAR(dgen_segavr_hmd_yaw_scale, 12);
RCVAR(dgen_segavr_hmd_pitch_const, 131072);
RCVAR(dgen_segavr_hmd_yaw_const, 524288);
RCVAR(dgen_segavr_axis0_threshold, 16384);
RCVAR(dgen_segavr_axis1_threshold, 16384);
RCVAR(dgen_segavr_axis2_threshold, 16384);
RCVAR(dgen_segavr_axis3_threshold, 8192);
RCVAR(dgen_segavr_axis4_threshold, 8192);
RCCTL(segavr_hmd_pitch_up, ',', JS_AXIS(0, 3, JS_AXIS_NEGATIVE), 0);
RCCTL(segavr_hmd_pitch_down, ',', JS_AXIS(0, 3, JS_AXIS_POSITIVE), 0);
...
#elif defined(WITH_GXZ80)
RCVAR(dgen_emu_z80, 4);
#else
