...
const char *emu_z80_names[] = { "none", "mz80", "cz80", "drz80", "gxz80", NULL };
...
struct rc_field rc_fields[RC_FIELDS_SIZE] = {
	...
	{ "int_window_width", rc_number, &dgen_window_width },
	{ "int_window_height", rc_number, &dgen_window_height },
#ifdef WITH_SEGAVR
	{ "bool_segavr_enabled", rc_boolean, &dgen_segavr_enabled },
	...
	{ "int_segavr_left_b", rc_number, &dgen_segavr_left_b },
	{ "int_segavr_right_r", rc_number, &dgen_segavr_right_r },
	...
	{ "int_segavr_hmd_pitch_scale", rc_number, &dgen_segavr_hmd_pitch_scale },
	{ "int_segavr_hmd_yaw_scale", rc_number, &dgen_segavr_hmd_yaw_scale },
	{ "int_segavr_hmd_pitch_const", rc_number, &dgen_segavr_hmd_pitch_const },
	{ "int_segavr_hmd_yaw_const", rc_number, &dgen_segavr_hmd_yaw_const },
	{ "int_segavr_axis0_threshold", rc_number, &dgen_segavr_axis0_threshold },
	{ "int_segavr_axis1_threshold", rc_number, &dgen_segavr_axis1_threshold },
	{ "int_segavr_axis2_threshold", rc_number, &dgen_segavr_axis2_threshold },
	{ "int_segavr_axis3_threshold", rc_number, &dgen_segavr_axis3_threshold },
	{ "int_segavr_axis4_threshold", rc_number, &dgen_segavr_axis4_threshold },
	{ "joy_hmd_pitch_up", rc_joypad, &segavr_hmd_pitch_up[RCBJ] },
	{ "joy_hmd_pitch_down", rc_joypad, &segavr_hmd_pitch_down[RCBJ] },
	{ "joy_hmd_yaw_left", rc_joypad, &segavr_hmd_yaw_left[RCBJ] },
	{ "joy_hmd_yaw_right", rc_joypad, &segavr_hmd_yaw_right[RCBJ] },
	{ "mou_hmd_pitch_up", rc_joypad, &segavr_hmd_pitch_up[RCBM] },
	{ "mou_hmd_pitch_down", rc_joypad, &segavr_hmd_pitch_down[RCBM] },
	{ "mou_hmd_yaw_left", rc_joypad, &segavr_hmd_yaw_left[RCBM] },
	{ "mou_hmd_yaw_right", rc_joypad, &segavr_hmd_yaw_right[RCBM] },
	{ "key_hmd_pitch_up", rc_joypad, &segavr_hmd_pitch_up[RCBK] },
	{ "key_hmd_pitch_down", rc_joypad, &segavr_hmd_pitch_down[RCBK] },
	{ "key_hmd_yaw_left", rc_joypad, &segavr_hmd_yaw_left[RCBK] },
	{ "key_hmd_yaw_right", rc_joypad, &segavr_hmd_yaw_right[RCBK] },
	...
	{ "int_openvr_eyex", rc_number, &dgen_openvr_eyex },
	{ "int_openvr_eyey", rc_number, &dgen_openvr_eyey },
...
extern "C" int rc_get_ym_lowpass_cutoff()
{
	return (int)dgen_ym_lowpass_cutoff;
}
