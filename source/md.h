...
#ifdef WITH_SEGAVR
extern int M68K_CYCLES_PER_LINE;
extern int M68K_CYCLES_HBLANK;
extern int M68K_CYCLES_VDELAY;
extern int Z80_CYCLES_PER_LINE;
extern int Z80_CYCLES_HBLANK;
extern int Z80_CYCLES_VDELAY;
#else
...
#endif
#ifdef WITH_GXZ80
	static class md* md_gxz80;
	unsigned int md_gxz80_ref;
	class md* md_gxz80_prev;

	bool md_set_gxz80(bool set);
	void md_set_gxz80_sync(bool push);
#endif
...
public:
...
#ifdef WITH_NUKEDOPN2
  ym3438_t opn2;
  static const int skYm3438CyclesPerSample = 24;
  static const int skYm3438FrameSampleCount = 1080 * 2 * skYm3438CyclesPerSample;
  int16_t ym3438_accm[skYm3438CyclesPerSample][2];
  int16_t ym3438_frame_buffer[skYm3438FrameSampleCount];
  int ym3438_frame_ptr;
  int ym3438_frame_cycles;
  int ym3438_sample[2];
  int ym3438_sample_prev[2];
  int ym3438_cycles;
  void ym3438_update_buffer(int cycles);
#endif
  ...
  int get_z80_irq_vector() { return z80_irq_vector; }
private:
#ifdef WITH_MZ80
...
// invblank, inhblank, dma busy, pal
  ...
  static const uint32_t max_rom_banks = 16; //8MB of addressable ROM (as per M68K_ROM_END) in 512KB chunks
  uint32_t rom_bank_offsets[max_rom_banks];
...
public:
  ...
  void segavr_init();
  void segavr_cleanup();
  void segavr_register_vblank();
  void segavr_begin_scan();
