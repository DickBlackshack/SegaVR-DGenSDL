...
extern void gx_z80_init(const void *config, int (*irqcallback)(int));
extern void gx_z80_reset (void);
extern void gx_z80_run(unsigned int cycles);
extern void gx_z80_get_context (void *dst);
extern void gx_z80_set_context (void *src);
extern void gx_z80_set_irq_line(unsigned int state);
extern void gx_z80_set_nmi_line(unsigned int state);
